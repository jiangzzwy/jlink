...
public class ListOptions extends CommandLineOptions {
    ...
    public ListOptions(CommandLine line) {
        super(line);
        this.showAll = line.hasOption(CliFrontendParser.ALL_OPTION.getOpt());
        this.showRunning = line.hasOption(CliFrontendParser.RUNNING_OPTION.getOpt());
        this.showScheduled = line.hasOption(CliFrontendParser.SCHEDULED_OPTION.getOpt());
    }
