...
import static com.jlink.flink.client.cli.ProgramOptionsUtils.containsPythonDependencyOptions;
import static com.jlink.flink.client.cli.ProgramOptionsUtils.createPythonProgramOptions;
import static com.jlink.flink.client.cli.ProgramOptionsUtils.isPythonEntryPoint;
...
public class ProgramOptions extends CommandLineOptions {
    ...
    protected ProgramOptions(CommandLine line) throws CliArgsException {
        ...
        this.entryPointClass =
                line.hasOption(CliFrontendParser.CLASS_OPTION.getOpt())
                        ? line.getOptionValue(CliFrontendParser.CLASS_OPTION.getOpt())
                        : null;

        this.jarFilePath =
                line.hasOption(CliFrontendParser.JAR_OPTION.getOpt())
                        ? line.getOptionValue(CliFrontendParser.JAR_OPTION.getOpt())
                        : null;
        ...
        detachedMode =
                line.hasOption(CliFrontendParser.DETACHED_OPTION.getOpt())
                        || line.hasOption(CliFrontendParser.YARN_DETACHED_OPTION.getOpt());
        shutdownOnAttachedExit = line.hasOption(CliFrontendParser.SHUTDOWN_IF_ATTACHED_OPTION.getOpt());
    ...
    protected String[] extractProgramArgs(CommandLine line) {
        String[] args =
                line.hasOption(CliFrontendParser.ARGS_OPTION.getOpt())
                        ? line.getOptionValues(CliFrontendParser.ARGS_OPTION.getOpt())
                        : line.getArgs();
