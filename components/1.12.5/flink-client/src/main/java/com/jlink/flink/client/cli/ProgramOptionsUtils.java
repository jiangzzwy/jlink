...
import com.jlink.flink.client.program.PackagedProgram;
import com.jlink.flink.client.program.PackagedProgramUtils;
...
public enum ProgramOptionsUtils {
    ...
    public static boolean isPythonEntryPoint(CommandLine line) {
        return line.hasOption(CliFrontendParser.PY_OPTION.getOpt())
                || line.hasOption(CliFrontendParser.PYMODULE_OPTION.getOpt())
                || "org.apache.flink.client.python.PythonGatewayServer"
                        .equals(line.getOptionValue(CliFrontendParser.CLASS_OPTION.getOpt()));
    }
    ...
    public static boolean containsPythonDependencyOptions(CommandLine line) {
        return line.hasOption(CliFrontendParser.PYFILES_OPTION.getOpt())
                || line.hasOption(CliFrontendParser.PYREQUIREMENTS_OPTION.getOpt())
                || line.hasOption(CliFrontendParser.PYARCHIVE_OPTION.getOpt())
                || line.hasOption(CliFrontendParser.PYEXEC_OPTION.getOpt());
    }
