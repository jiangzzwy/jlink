...
package com.jlink.flink.client.program;
...
public class StreamContextEnvironment extends StreamExecutionEnvironment {
    ...
    public JobExecutionResult execute(StreamGraph streamGraph) throws Exception {
        ...
        try {
            ...
            //执行回调
            if(getConfiguration().contains(CustomOptions.CUSTOM_CALLBACK_URL)) {
                FlinkStatusUtils.callBack(getConfiguration().getString(CustomOptions.CUSTOM_CALLBACK_URL), DeployResultHolder.get());
            }
