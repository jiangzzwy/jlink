...
class StopOptions extends CommandLineOptions {
    ...
    StopOptions(CommandLine line) {
        ...
        this.savepointFlag = line.hasOption(CliFrontendParser.STOP_WITH_SAVEPOINT_PATH.getOpt());
        this.targetDirectory = line.getOptionValue(CliFrontendParser.STOP_WITH_SAVEPOINT_PATH.getOpt());
